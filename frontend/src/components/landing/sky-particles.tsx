...
export const SkyParticles = ({
  ...
  const particlesRef = useRef<Array<{ x: number; y: number; size: number; speedX: number; speedY: number; opacity: number; update: () => void; draw: (ctx: CanvasRenderingContext2D, color: string) => void }>>([])
  ...
  }, [dimensions.width, dimensions.height, maxSize, minSize, particleColor, particleDensity, mouse.x, mouse.y])
